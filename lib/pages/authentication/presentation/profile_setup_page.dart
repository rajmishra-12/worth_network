                  ...
                  if (sizeInMb > 2.0) {
                    if (pageContext.mounted) {
                      ScaffoldMessenger.of(pageContext).showSnackBar(
                        SnackBar(
                          content: Text(loc.translate('photo_size_warning')),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // Header
                  Text(
                    loc.translate('setup_profile_title'),
                    style: CustomTextStyle.size24W600(color: AppColors.white100),
                  ),
                  const SizedBox(height: AppSize.spacingS),
                  Text(
                    loc.translate('setup_profile_desc'),
                  ...
                  Center(
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: AppSize.spacingS),
                        Text(
                          loc.translate('choose_profile_picture'),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: loc.translate('enter_username_hint'),
                  ...
                  TextField(
                    ...
                    style: CustomTextStyle.size15W400(color: AppColors.white100),
                    decoration: InputDecoration(
                      hintText: loc.translate('bio_placeholder'),
                      hintStyle: CustomTextStyle.size14W400(color: AppColors.grey500),
                      filled: true,
                      fillColor: AppColors.grey900,
                      border: OutlineInputBorder(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isLoading
                          ...
                          : Text(
                              loc.translate('save_and_continue_btn'),
