...
class AdminAuditLogPage extends StatelessWidget {
  ...
  Widget _buildActionTag(String actionType, AppLocalizations loc) {
    ...
    final key = 'action_type_$actionType';
    final translatedLabel = loc.translate(key);
    final label = translatedLabel != key ? translatedLabel : actionType.replaceAll('_', ' ').toUpperCase();
      ...
      builder: (context, localeCode) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            title: Text(loc.translate('moderation_audit_logs'), style: CustomTextStyle.size18W600(color: AppColors.white100)),
            leading: IconButton(
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(loc.translate('no_audit_logs_title'), style: CustomTextStyle.size18W600(color: AppColors.white100)),
                      const SizedBox(height: 4),
                      Text(loc.translate('no_audit_logs_desc'), style: CustomTextStyle.size14W400(color: AppColors.grey400)),
                    ],
                  ),
                );
              }
