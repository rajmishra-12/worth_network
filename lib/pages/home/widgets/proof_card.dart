...
class _DocumentProofViewer extends StatelessWidget {
  ...
  void _showLocalDocumentModal(BuildContext context) {
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.picture_as_pdf, color: AppColors.info, size: 40),
              ),
              ...
              Text(
                localFile != null
                    ? 'Document attached successfully and ready to be posted as proof.'
                    : 'Document link attached to this action.',
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(loc.translate('btn_next') == 'Suivant' ? 'Ouvrir le document' : 'Open Document'),
              ...
              SizedBox(
                ...
                child: TextButton(
                  onPressed: () => Navigator.pop(context),
                  child: Text(
                    loc.translate('dismiss') == 'Fermer' ? 'Fermer' : 'Close',
